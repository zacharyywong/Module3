...
int main(){
  ...
  blank2 = (person_t*)qsearch(queue1, searchfn, (void*)sarah);
	print_person(blank2);

	// search for sarah (present);
	blank3 = (person_t*)qsearch(queue2, searchfn, (void*)billie);
	print_person(blank3);

	//remove
	blank1 = (person_t*)qremove(queue1, searchfn, (void*)mikaela);
	print_queue("queue1", queue1);
	
	blank2 = (person_t*)qremove(queue2, searchfn, (void*)sarah);
	print_queue("queue2", queue2);
